...
public interface Department {
     ...
     */
    void enrollStudent(@Nonnull Student student) throws IllegalArgumentException;
     ...
     */
    Student removeStudent(@Nonnull Student student) throws IllegalArgumentException;
     ...
     */
    void addCourse(@Nonnull Course course) throws IllegalArgumentException;
     ...
     */
    Course removeCourse(@Nonnull Course course) throws IllegalArgumentException;
